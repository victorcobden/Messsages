...
namespace MessagesBackend
{
    public class Startup
    {
        ...
        {
            context.Add(new Message { Owner = "Victor", Text = "Programmer" });
            context.Add(new Message { Owner = "Gabriela", Text = "CEO at Dhamyc" });
            context.Add(new Message { Owner = "Cesar", Text = "Java developer" });
            context.Add(new Message { Owner = "Diego", Text = "Unity Developer" });
            context.SaveChanges();
        }
    }
}
